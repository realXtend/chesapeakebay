...
// NOT: watersplash.particle
// NOT: watersplash_drops.particle
// NOT: watersplash_hispeed.particle
...
/*        for ( var index = 1; index < 3; ++index)
    ...
    ExitGame: function() {
        ...
        if (this.hudWidget_) {
            ...
            print("WARNING in osprey_avatar_controller.js: no this.hudWidget_ in ExitGame.");
        }
        this.hudWidget_ = null;
        this.lcdTimeDisplay_ = null;
        this.scoreLayout_ = null;
...
//        camera.AutoSetPlaceable();
    ...
    MoveOsprey: function(frameTime) {
        ...
        if (this.motionStateY_ == -1) {
            ...
            this.angle_ = this.angle_ + this.angularSpeed_ * frameTime;
            tm.rot.y = (180 / Math.PI * this.angle_) % 360;
        ...
        if (this.motionStateX_ == 1) {
            ...
            tm.pos.y += frameTime * this.speed_;
        ...
        if (this.motionStateX_ == -1) {
            ...
            tm.pos.y -= frameTime * this.dive_speed_;
